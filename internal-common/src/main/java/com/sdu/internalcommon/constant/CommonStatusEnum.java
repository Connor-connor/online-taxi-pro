...
/*        PRICE_RULE_EMPTY(1300,"计价规则不存在"),
        ...
        DRIVER_CAR_BIND_NOT_EXISTS(1500,"驾驶员和车辆绑定关系不存在"), // 驾驶员和车辆：1500-1599

        DRIVER_NOT_EXITST(1501,"驾驶员不存在"),

        DRIVER_CAR_BIND_EXISTS(1502,"驾驶员和车辆绑定关系已存在，请勿重复绑定"),

        DRIVER_BIND_EXISTS(1503,"驾驶员已经被绑定了，请勿重复绑定"),

        CAR_BIND_EXISTS(1504,"车辆已经被绑定了，请勿重复绑定"),

        CITY_DRIVER_EMPTY(1505,"当前城市没有可用的驾驶员"),

        AVAILABLE_DRIVER_EMPTY(1506,"可用的驾驶员为空"),
